(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@valeera/eventdispatcher'), require('@valeera/mathx'), require('@valeera/idgenerator')) :
	typeof define === 'function' && define.amd ? define(['exports', '@valeera/eventdispatcher', '@valeera/mathx', '@valeera/idgenerator'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Engine = {}, global.EventDispatcher, global.mathx, global.IdGenerator));
}(this, (function (exports, EventDispatcher, mathx, IdGenerator) { 'use strict';
	...
	***************************************************************************** */
	...
	class WebGPUEngine extends EventDispatcher__default['default'] {
	    constructor(canvas) {
	        super();
	        this.inited = false;
	        this.canvas = canvas;
	...
	class Matrix4Component extends Component {
	    constructor(name, data = mathx.Matrix4.create()) {
	        super(name, data);
	    }
	}
	...
	class PerspectiveProjection extends AProjection3 {
	    ...
	    update() {
	        mathx.Matrix4.perspective(this.fovy, this.aspect, this.near, this.far, this.data);
	        this.dirty = true;
	        return this;
	    }
	}
