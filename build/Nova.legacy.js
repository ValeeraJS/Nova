(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@valeera/timeline'), require('@valeera/eventdispatcher'), require('@valeera/idgenerator'), require('@valeera/mathx'), require('@valeera/x'), require('@valeera/tree')) :
	typeof define === 'function' && define.amd ? define(['exports', '@valeera/timeline', '@valeera/eventdispatcher', '@valeera/idgenerator', '@valeera/mathx', '@valeera/x', '@valeera/tree'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Nova = {}, global.timeline, global.EventDispatcher, global.IdGenerator, global.mathx, global.x$4, global.tree));
})(this, (function (exports, timeline, EventDispatcher, IdGenerator, mathx, x$4, tree) { 'use strict';
	...
	var mathx__namespace = /*#__PURE__*/_interopNamespace(mathx);
	...
	***************************************************************************** */
	...
	var createTriangle3 = (function (t, options, topology, cullMode) {
	    if (t === void 0) { t = mathx.Triangle3.create(); }
	    ...
	    if (options.combine) {
	        ...
	        result.set(t.c, stride + stride);
	        if (options.hasNormal) {
	            var normal = mathx.Triangle3.normal(t);
	            result.set(normal, 3);
	            result.set(normal, stride + 3);
	            result.set(normal, stride + stride + 3);
	            pickers.push({
	...
	var TextureMaterial = /** @class */ (function (_super) {
	    ...
	    function TextureMaterial(texture, sampler) {
	        if (sampler === void 0) { sampler = new Sampler(); }
	        var _this = _super.call(this, wgslShaders.vertex, wgslShaders.fragment, [
	            {
	                binding: 1,
	                name: "mySampler",
	                type: "sampler",
	...
	var Matrix4Component = /** @class */ (function (_super) {
	    ...
	    function Matrix4Component(name, data) {
	        if (data === void 0) { data = mathx.Matrix4.create(); }
	...
	var EuclidPosition3 = /** @class */ (function (_super) {
	    ...
	    function EuclidPosition3(vec3) {
	        ...
	        var _this = _super.call(this) || this;
	        _this.vec3 = new mathx.Vector3();
	        _this.data = mathx.Matrix4.identity();
	        mathx.Vector3.fromArray(vec3, 0, _this.vec3);
	        _this.update();
	        return _this;
	    }
	...
	var getEulerRotation3Proxy = (function (position) {
	    ...
	    var euler = mathx.EulerAngle.fromMatrix4(position.data);
	    return new Proxy(position, {
	        get: function (target, property) {
	...
	var Clearer = /** @class */ (function () {
	    function Clearer(engine, color) {
	        if (color === void 0) { color = new mathx.ColorGPU(); }
	        this.color = new mathx.ColorGPU();
	        this.engine = engine;
	        this.setColor(color);
	    ...
	    Clearer.prototype.setColor = function (color) {
	        if (color instanceof mathx.ColorGPU) {
	            ...
	            mathx.ColorGPU.fromString(color, this.color);
	        }
	        else if (typeof color === "number") {
	            mathx.ColorGPU.fromHex(color, 1, this.color);
	        }
	        else if (color instanceof mathx.ColorRGB) {
	            mathx.ColorGPU.fromColorRGB(color, this.color);
	        }
	        else if (color instanceof mathx.ColorRGBA) {
	            mathx.ColorGPU.fromColorRGBA(color, this.color);
	        }
	        else if (color instanceof Float32Array || color instanceof Array) {
	            mathx.ColorGPU.fromArray(color, this.color);
	        }
	        else if (color instanceof Float32Array || color instanceof Array) {
	            mathx.ColorGPU.fromArray(color, this.color);
	        }
	            ...
	            if ("a" in color) {
	                mathx.ColorGPU.fromJson(color, this.color);
	            }
	            else {
	                mathx.ColorGPU.fromJson(__assign(__assign({}, color), { a: 1 }), this.color);
	            }
	        }
	        return this;
	    };
	...
	var MeshRenderer = /** @class */ (function () {
	    ...
	    MeshRenderer.prototype.render = function (mesh, camera, passEncoder, _scissor) {
	        ...
	        // 假设更换了几何体和材质则重新生成缓存
	        var material = mesh.getComponent(MATERIAL) || DEFAULT_MATERIAL;
	    ...
	    MeshRenderer.prototype.createCacheData = function (mesh) {
	        ...
	        var geometry = mesh.getComponent(GEOMETRY_3D);
	        var material = mesh.getComponent(MATERIAL) || DEFAULT_MATERIAL;
	        var nodes = geometry.data;
	        for (var i = 0; i < nodes.length; i++) {
	            buffers.push(createVerticesBuffer(device, nodes[i].data));
	        }
	        var pipeline = this.createPipeline(geometry, material);
	        var groupEntries = [{
	                binding: 0,
	                resource: {
	    ...
	    MeshRenderer.prototype.createPipeline = function (geometry, material) {
	        var pipelineLayout = this.engine.device.createPipelineLayout({
	            bindGroupLayouts: [this.createBindGroupLayout(material)],
	        });
	        var vertexBuffers = this.parseGeometryBufferLayout(geometry);
	        var stages = this.createStages(material, vertexBuffers);
	    ...
	    MeshRenderer.prototype.parseGeometryBufferLayout = function (geometry) {
	        var vertexBuffers = [];
	        var location = 0;
	    ...
	    MeshRenderer.prototype.createBindGroupLayout = function (material) {
	        var uniforms = material.data.uniforms;
	        var entries = [
	            {
	                binding: 0,
	    ...
	    MeshRenderer.prototype.createStages = function (material, vertexBuffers) {
	        var vertex = {
	...
	var TreeNodeWithEvent = EventDispatcher.mixin(tree.TreeNode);
	...
	Object.defineProperty(exports, 'Timeline', {
		enumerable: true,
		get: function () { return timeline__default["default"]; }
	});
	Object.defineProperty(exports, 'EventFire', {
		enumerable: true,
		get: function () { return EventDispatcher__default["default"]; }
	});
	exports.Mathx = mathx__namespace;
	...
	exports.WebGPUMeshRenderer = MeshRenderer;
	exports.WebGPURenderSystem = RenderSystem;
	Object.keys(x$4).forEach(function (k) {
		if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
			enumerable: true,
			get: function () { return x$4[k]; }
		});
	});
...
//# sourceMappingURL=Nova.legacy.js.map
